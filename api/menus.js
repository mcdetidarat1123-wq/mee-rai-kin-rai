...
กฎการตอบ:
- คิดเมนูที่ทำได้จริง 8 เมนู โดยใช้วัตถุดิบที่ผู้ใช้มีให้ได้มากที่สุด อนุญาตให้มีวัตถุดิบพื้นฐานเพิ่มเล็กน้อยได้ (เช่น น้ำมัน เกลือ น้ำตาล ซีอิ๊ว) แต่ให้ทำเครื่องหมาย have:false ถ้าไม่ได้อยู่ในลิสต์ที่ผู้ใช้ให้มา
    ...
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'user',
            content: `วัตถุดิบที่มีอยู่:\n${ingredientList}\n\nช่วยคิดเมนู 8 แบบตามกฎที่กำหนด`,
          },
        ],
      }),
    });
